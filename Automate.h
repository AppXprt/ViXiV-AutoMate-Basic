...
public:
	...
	ViXiVFrameBaseClass(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("ViXiV Automate Basic"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 443,562 ), long style = wxCAPTION|wxSYSTEM_MENU|wxCLOSE_BOX|wxTAB_TRAVERSAL );
